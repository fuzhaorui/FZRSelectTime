...
#import "FZRWeekView.h"

@interface FZRMonthView ()
@property (nonatomic, strong)NSMutableArray *weeksViews;
@property (nonatomic, strong)UILabel *titleLab;
@end

@implementation FZRMonthView {
...
- (void)reload {
    ...
    for (int i = 0; i < weekNumber; i++) {
        FZRWeekView *weekView = [[FZRWeekView alloc] initWithFrame:CGRectMake(0, weekH+gap*2 + (weekH+gap)*i, self.frame.size.width, weekH)];
