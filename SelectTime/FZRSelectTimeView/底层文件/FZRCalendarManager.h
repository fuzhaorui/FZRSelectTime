...
@interface FZRCalendarManager : NSObject
@property (nonatomic, strong)FZRDateHelper *helper;
...
// 选中的按钮(开始和结束)
@property (nonatomic, strong)FZRDayView *selectedStartDay;
@property (nonatomic, strong)FZRDayView *selectedEndDay;
// 多选模式中保存选中的时间
