...
#import "FZRMonthView.h"
#import "FZRDateHelper.h"

@implementation FZRCalendarView {
    CGSize lastSize;
    
    FZRMonthView *monthView1;
    FZRMonthView *monthView2;
    FZRMonthView *monthView3;
    FZRMonthView *monthView4;
    FZRMonthView *monthView5;
}
...
- (FZRCalendarManager *)manager {
    if (!_manager) {
        _manager = [FZRCalendarManager new];
    }
    return _manager;
}
...
- (void)repositionViews {
    ...
    if (!monthView1) {
        monthView1 = [[FZRMonthView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 0)];
        monthView2 = [[FZRMonthView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 0)];
        monthView3 = [[FZRMonthView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 0)];
        monthView4 = [[FZRMonthView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 0)];
        monthView5 = [[FZRMonthView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 0)];
...
- (void)loadPreviousPage {
    ...
    FZRMonthView *tmpView = monthView5;
...
- (void)loadNextPage {
    ...
    FZRMonthView *tmpView = monthView1;
